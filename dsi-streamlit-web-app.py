...
st.subheader("Enter customer information ands submit for likelihood to purchase")
...
if st.button("Submit for Prediction"):
    ...
    # apply model pipeline to thte input data and extract probability prediction
